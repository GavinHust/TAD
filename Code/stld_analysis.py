...
# dir = "SF_new/"          #平均度大的SF网络，为了画detaGSCC
file_pre = "ER_1000_"  # 文件以tes_开头
...
for file in filenames:
    ...
    # model_DND, optimizer_DND = load_DND(model_DND, optimizer_DND, 'model_checkpoint_SFandER.pth')     #真实网络
    ...
    # file_test_list = ["SF_8.91_200_2.5",'SF_1000_2.2_0.2_0.55_9.48', 'SF_1000_2.5_0.49_0.9_7.13', 'SF_1000_2.8_0.6_0.87_6.29', 'SF_1000_3.2_0.82_0.99_5.33']
    file_test_list = []
    flag = 1
    ...
    np.save('final_DN_result/' + filename + '_DND.npy', strong_list_DND)  # 训练集只有SF网络
    np.save('final_DN_result/' + filename + '_FD.npy', strong_list_FINDER)
    np.save('final_DN_result/' + filename + '_control_new.npy', strong_list_control)
