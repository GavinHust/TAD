...
def draw_bar_c_new_SFandER():   #绘制多个网络的bar
    ...
    for epoch in range(len(file_list)):
        ...
        for i in range(len(network_names)):
            ...
            #print('网络名称：', name)
            back = np.load('../Data/DNdata/NPY/Synthetic/F/SF/' + name + '_back.npy')
            #print(back)
            # print(len(back))
            degree = np.load('../Data/DNdata/NPY/Synthetic/F/SF/' + name + '_degree.npy')
            finder = np.load('../Data/DNdata/NPY/Synthetic/F/SF/' + name + '_FD.npy')
            MS = np.load('../Data/DNdata/NPY/Synthetic/F/SF/' + name + '_MS.npy')
            adpDegree = np.load('../Data/DNdata/NPY/Synthetic/F/SF/' + name + '_adpDegree.npy')
            PR = np.load('../Data/DNdata/NPY/Synthetic/F/SF/' + name + '_PR.npy')
            DND = np.load('../Data/DNdata/NPY/Synthetic/F/SF/' + name + '_DND.npy')
            CoreHD = np.load('../Data/DNdata/NPY/Synthetic/F/SF/' + name + '_Core.npy')
    ...
    for epoch in D:
        ...
        for i in range(len(network_names)):
            name = network_names[i]  # [:-4]
            #print('网络名称：', name)
            back = np.load('../Data/DNdata/NPY/Synthetic/F/ER/' + name + '_back.npy')
            #print(back)
            # print(len(back))
            degree = np.load('../Data/DNdata/NPY/Synthetic/F/ER/' + name + '_degree.npy')
            finder = np.load('../Data/DNdata/NPY/Synthetic/F/ER/' + name + '_FD.npy')
            MS = np.load('../Data/DNdata/NPY/Synthetic/F/ER/' + name + '_MS.npy')
            adpDegree = np.load('../Data/DNdata/NPY/Synthetic/F/ER/' + name + '_adpDegree.npy')
            PR = np.load('../Data/DNdata/NPY/Synthetic/F/ER/' + name + '_PR.npy')
            DND = np.load('../Data/DNdata/NPY/Synthetic/F/ER/' + name + '_DND.npy')
            CoreHD = np.load('../Data/DNdata/NPY/Synthetic/F/ER/' + name + '_Core.npy')
    ...
    axs[1].text(0.68, 0.15, 'Reversed Link', transform=axs[1].transAxes, fontsize=12, va='top', ha='left')
