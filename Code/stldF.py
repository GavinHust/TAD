...
for file in filenames:
    ...
    model_DND, optimizer_DND = load_DND(model_DND, optimizer_DND, 'model_checkpoint_SFandER.pth')  # SFandER网络
    ...
    # file_test_list =  ["F_1000_0.2_0.07_0", "F_1000_0.5_0.75_0", "F_1000_0.8_6.0_0", "F_1000_1.0_0" ]
    file_test_list = []
    flag = 1
    ...
    # y= np.linspace(0, strong_list_FINDER[0], 1000)
